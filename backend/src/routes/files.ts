...
function resolveServerPath(serverId: string, relativePath: string) {
...
export function registerFileRoutes(app: Express) {
  app.get("/api/v1/servers/:id/files/list", requireAuth, async (req: Request, res: Response) => {
    const { id } = req.params;
  ...
  app.get("/api/v1/servers/:id/files/content", requireAuth, async (req: Request, res: Response) => {
    const { id } = req.params;
    const relPath = String(req.query.path || "/");
    try {
      const full = resolveServerPath(id, relPath);
  ...
  app.put("/api/v1/servers/:id/files/content", requireAuth, async (req: Request, res: Response) => {
    const { id } = req.params;
  ...
  app.post("/api/v1/servers/:id/files/mkdir", requireAuth, async (req: Request, res: Response) => {
    const { id } = req.params;
    const relPath = String(req.body.path || "/");
    try {
      const full = resolveServerPath(id, relPath);
  ...
  app.post("/api/v1/servers/:id/files/rename", requireAuth, async (req: Request, res: Response) => {
    const { id } = req.params;
  ...
  app.post("/api/v1/servers/:id/files/delete", requireAuth, async (req: Request, res: Response) => {
    const { id } = req.params;
    const relPath = String(req.body.path || "/");
    try {
      const full = resolveServerPath(id, relPath);
  ...
  app.post("/api/v1/servers/:id/files/upload", requireAuth, async (req: Request, res: Response) => {
    const { id } = req.params;
    const relPath = String(req.query.path || "/");
  ...
  app.post("/api/v1/servers/:id/files/archive", requireAuth, async (req: Request, res: Response) => {
    const { id } = req.params;
    const relPath = String(req.body.path || "/");
  ...
  app.post("/api/v1/servers/:id/files/extract", requireAuth, async (req: Request, res: Response) => {
    const { id } = req.params;
    const relPath = String(req.body.path || "/");
    try {
      const src = resolveServerPath(id, relPath);
